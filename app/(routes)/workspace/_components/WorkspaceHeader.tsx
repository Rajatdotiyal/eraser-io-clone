...
function WorkspaceHeader({onSave,fileName} : {onSave: () => void,fileName : string}) {
  return (
    <div className="p-3 border-b flex justify-between items-center">
      <div className="flex gap-2 items-center">
        <Image src={"/eraser.png"} alt="logo" height={40} width={40} />
        <h2 className="font-semibold font-serif text-muted-foreground">{fileName}</h2>
      </div>
